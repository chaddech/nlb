...
model.add(Convolution2D(32,3,3,
			 init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))


model.add(Convolution2D(32,3,3,init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))
...
model.add(Convolution2D(64,3,3, init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))
...
model.add(Convolution2D(128,3,3, init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))
...
model.add(Convolution2D(256,3,3, init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))
...
model.add(Convolution2D(16,3,3, init='he_normal', W_regularizer=l2(.0001)))
model.add(BatchNormalization(mode=0, axis=1))
model.add(Activation('relu'))
